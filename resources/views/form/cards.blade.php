...
@if(old('cards.visa') == 1) checked @endif />
...
@if(old('cards.mastercard') == 1) checked @endif />
...
@if(old('cards.jcb') == 1) checked @endif />
...
@if(old('cards.diners') == 1) checked @endif />
...
@if(old('cards.amex') == 1) checked @endif />
...
@if(old('cards.other') == 1) checked @endif />
