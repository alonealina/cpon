...
@if($holidays['monday'] == 1) checked @endif />
...
@if($holidays['tuesday'] == 1) checked @endif />
...
@if($holidays['wednesday'] == 1) checked @endif />
...
@if($holidays['thursday'] == 1) checked @endif />
...
@if($holidays['friday'] == 1) checked @endif />
...
@if($holidays['saturday'] == 1) checked @endif />
...
@if($holidays['sunday'] == 1) checked @endif />
...
@if($holidays['none'] == 1) checked @endif />
