...
@if(old('holidays.monday') == 1) checked 
@elseif(empty(old('holidays')) && $holidays['monday'] == 1) checked @endif />
...
@if(old('holidays.tuesday') == 1) checked 
@elseif(empty(old('holidays')) && $holidays['tuesday'] == 1) checked @endif />
...
@if(old('holidays.wednesday') == 1) checked 
@elseif(empty(old('holidays')) && $holidays['wednesday'] == 1) checked @endif />
...
@if(old('holidays.thursday') == 1) checked 
@elseif(empty(old('holidays')) && $holidays['thursday'] == 1) checked @endif />
...
@if(old('holidays.friday') == 1) checked 
@elseif(empty(old('holidays')) && $holidays['friday'] == 1) checked @endif />
...
@if(old('holidays.saturday') == 1) checked 
@elseif(empty(old('holidays')) && $holidays['saturday'] == 1) checked @endif />
...
@if(old('holidays.sunday') == 1) checked 
@elseif(empty(old('holidays')) && $holidays['sunday'] == 1) checked @endif />
...
@if(old('holidays.none') == 1) checked 
@elseif(empty(old('holidays')) && $holidays['none'] == 1) checked @endif />
