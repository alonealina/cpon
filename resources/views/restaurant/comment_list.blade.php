...
<div class="comment_list" id="comment_list">
    ...
    <div>
        ...
        <div class="comment_list_content">
            ...
            <a href="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img1 }}" data-lightbox="group{{ $comment->id }}pc">
                <img src="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img1 }}" width="100px" height="100px">
            </a>
            @endif
            @if (!empty($comment->comment_img2))
            <a href="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img2 }}" data-lightbox="group{{ $comment->id }}pc">
                <img src="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img2 }}" width="100px" height="100px">
            </a>
            @endif
            @if (!empty($comment->comment_img3))
            <a href="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img3 }}" data-lightbox="group{{ $comment->id }}pc">
                <img src="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img3 }}" width="100px" height="100px">
            </a>
            @endif
            @if (!empty($comment->comment_img4))
            <a href="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img4 }}" data-lightbox="group{{ $comment->id }}pc">
                <img src="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img4 }}" width="100px" height="100px">
            </a>
            @endif
            @if (!empty($comment->comment_img5))
            <a href="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img5 }}" data-lightbox="group{{ $comment->id }}pc">
                <img src="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img5 }}" width="100px" height="100px">
            </a>
            @endif
        </div>
        <hr>
...
<div class="comment_list" id="comment_list">
    ...
    <div>
        ...
        <div class="comment_list_content">
            ...
            @if (!empty($comment->comment_img1))
            <a href="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img1 }}" data-lightbox="group{{ $comment->id }}ipad">
                <img src="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img1 }}" width="100px" height="100px">
            </a>
            @endif
            @if (!empty($comment->comment_img2))
            <a href="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img2 }}" data-lightbox="group{{ $comment->id }}ipad">
                <img src="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img2 }}" width="100px" height="100px">
            </a>
            @endif
            @if (!empty($comment->comment_img3))
            <a href="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img3 }}" data-lightbox="group{{ $comment->id }}ipad">
                <img src="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img3 }}" width="100px" height="100px">
            </a>
            @endif
            @if (!empty($comment->comment_img4))
            <a href="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img4 }}" data-lightbox="group{{ $comment->id }}ipad">
                <img src="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img4 }}" width="100px" height="100px">
            </a>
            @endif
            @if (!empty($comment->comment_img5))
            <a href="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img5 }}" data-lightbox="group{{ $comment->id }}ipad">
                <img src="../../restaurant/{{ $restaurant_id }}/comment/{{ $comment->comment_img5 }}" width="100px" height="100px">
            </a>
            @endif
        </div>
