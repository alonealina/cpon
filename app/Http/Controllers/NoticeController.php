...
class NoticeController extends Controller
{
    ...
    {
        $notices = Notice::where('release_flg', 1)->orderBy('notice_date', 'desc')->orderBy('title', 'asc')->paginate(10);
    ...
    public function show($id)
    {
        ...
        $max_flg = false;
        $min_flg = false;
        $max_notice = Notice::where('release_flg', 1)->orderBy('notice_date', 'desc')->orderBy('title', 'asc')->first();
        $min_notice = Notice::where('release_flg', 1)->orderBy('notice_date', 'asc')->orderBy('title', 'desc')->first();
        if ($id == $max_notice->id) {
            $max_flg = true;
        }
        if ($id == $min_notice->id) {
        ...
        $notices = Notice::where('release_flg', 1)->orderBy('notice_date', 'desc')->orderBy('title', 'asc')->get();
